...
I assumed the population with a mixture of Gaussian distribution and use EM-algorithm to estimate the parameters. As long as I can obtain the estimator of proportion fractions, then the frequency of root cause is able to be estimated.
...
From above result, we know for each group the data is normally distributed. Since sample size is 30 in each group, we do not have much power. Then I also tested goodness of fit of Gamma distribution:
...
## experimental data (pretend unknown classification) & experimental data (known classification)
...
## observed data (unknown classification) & experimental data (known classification)
...
The functions for mixed gamma distribution is not robust. 